...
export function HeroSection() {
  return (
    <div className="relative w-full h-screen overflow-hidden" style={{ background: '#000000' }}>
      ...
      {/* Purple arc - right side */}
      <div className="absolute right-0 top-1/2 pointer-events-none" style={{ zIndex: 8, transform: 'translateY(-30%)' }}>
        ...
        <motion.img 
          ...
          className="h-[105vh] absolute top-0 right-0"
          style={{
            mixBlendMode: 'screen',
